...
if(isset($_GET['blog'])) {
  $url = $_GET['blog'];
  $arr = array("https://www.funhealtykey.com/2022/09/10-ways-to-fatten-gain-child-weight.html","https://www.funhealtykey.com/2022/09/11-Benefits-of-Propolis-Scientifically-Proven-Magical-Substance.html","https://www.funhealtykey.com/2022/09/4-recipes-to-gain-weight.html");
  header('location:'.$arr[array_rand($arr)].$url.'');
} else {
